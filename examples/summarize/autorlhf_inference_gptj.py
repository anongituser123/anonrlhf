...
rw_model = GPTRewardModel("AI/openai_summarize_tldr_ppo")
...
if __name__ == "__main__":
    model, tokenizer = load_model("AI/openai_summarize_tldr_ppo")

    test_post_list = [sample["prompt"] for sample in load_dataset("AI/openai_summarize_tldr", split="test")]
    test_summ_list = [sample["label"] for sample in load_dataset("AI/openai_summarize_tldr", split="test")]
