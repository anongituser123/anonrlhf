...
import autorlhf
from autorlhf.data.configs import (
    ModelConfig,
    OptimizerConfig,
    SchedulerConfig,
    TokenizerConfig,
...
from autorlhf.models.modeling_ppo import PPOConfig
...
if not os.path.exists(REWARD_CHECKPOINT_PATH):
    ...
    os.system(
        ...
        https://huggingface.co/AI/openai_summarize_tldr_rm_checkpoint/resolve/main/pytorch_model.bin"
    )
SFT_MODEL_PATH = "AI/openai_summarize_tldr_sft"
...
config = AutoRLHFConfig(
    ...
    model=ModelConfig(
        model_path="AI/openai_summarize_tldr_sft",
...
if __name__ == "__main__":
    ...
    def get_prompt_dataset(prompts, max_length):
        ...
        of prompts and summaries is consistent decode prompt from autorlhf pipeline
        """
        formatted_prompts = []
    ...
    dataset = load_dataset("AI/openai_summarize_tldr")
