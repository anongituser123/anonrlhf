...
def create_comparison_dataset(path="AI/openai_summarize_comparisons", split="train"):
...
if __name__ == "__main__":
    ...
    model = GPTRewardModel("AI/openai_summarize_tldr_sft")
    model.load_state_dict(torch.load("rm_checkpoint/pytorch_model.bin"))
    max_length = 550
    val_pairs = create_comparison_dataset("AI/openai_summarize_comparisons", "test")
