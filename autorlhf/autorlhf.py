...
from autorlhf.utils import set_seed
from autorlhf.utils.loading import get_pipeline, get_trainer
...
def train(  # noqa: C901
    ...
    config: Optional[AutoRLHFConfig] = None,
    ...
    Args:
        ...
        config (Optional[AutoRLHFConfig]): autorlhf configuration object
    ...
    if config is None:
        warnings.warn(
            ...
            "adapt some from `autorlhf/data/default_configs.py` instead"
        )
        if reward_fn:
