...
from autorlhf.pipeline import MiniBatchIterator
from autorlhf.trainer import BaseRLTrainer, register_trainer
from autorlhf.utils import (
    filter_non_scalars,
...
from autorlhf.utils.modeling import (
    flatten_dict,
...
class AccelerateRLTrainer(BaseRLTrainer):
    ...
    def setup_model(self):
        """
        Returns a model derived from an instance's AutoRLHFConfig
        """
    ...
    def setup_optimizer(self):
        """
        Returns an optimizer derived from an instance's AutoRLHFConfig
        """
    ...
    def setup_scheduler(self):
        """
        Returns a learning rate scheduler derived from an instance's AutoRLHFConfig
        """
    ...
    def evaluate(self):  # noqa: C901
        ...
        for i_sweep, gen_sweep_value in enumerate(gen_sweep_values):
            ...
            for i_prompt, prompts in enumerate(self.eval_dataloader):
                ...
                # TODO(d): this should be moved into `decode`
        ...
        for _ in range(self.config.train.epochs):
            ...
            for _ in range(self.n_inner_epochs):
                ...
                for minibatch in MiniBatchIterator(train_dataloader, self.mb_size, self.num_mb):
                    ...
                    # TODO(): Best way to combine stats between mbs?
