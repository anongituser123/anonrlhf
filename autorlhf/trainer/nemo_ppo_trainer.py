...
from autorlhf.data.ilql_types import flatten_dataclass
from autorlhf.data.ppo_types import PPORLBatch, PPORLElement
from autorlhf.models.modeling_nemo_ppo import PPOGPT
from autorlhf.models.modeling_ppo import FixedKLController, PPOConfig
from autorlhf.pipeline.offline_pipeline import PromptPipeline
from autorlhf.pipeline.ppo_pipeline import ppo_collate_fn
from autorlhf.trainer import BaseRLTrainer, register_trainer
from autorlhf.trainer.nemo_ilql_trainer import megatron_trainer
from autorlhf.utils import get_git_tag, infinite_dataloader
from autorlhf.utils.modeling import get_global_statistics, whiten
...
class NeMoPPOTrainer(BaseRLTrainer):
    def __init__(  # noqa: C901
        ...
        **kwargs,
        ...
        megatron_cfg.autorlhf = config.to_dict()
