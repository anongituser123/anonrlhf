...
from autorlhf.models.modeling_base import PreTrainedModelWrapper
...
class AutoModelForCausalLMWithValueHead(PreTrainedModelWrapper):
    ...
    def post_init(self, state_dict):
        ...
        autorlhf_checkpoint = any(k.startswith("base_model.") or k.startswith("v_head.") for k in state_dict)
        self.load_state_dict(state_dict, strict=autorlhf_checkpoint)
